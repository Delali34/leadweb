...
function Navbar() {
  ...
  return (
    <div>
      <div className="  top-[0] left-0 w-full lg:px-16 lg:py-1 px-8 py-2 bg-white hidden md:block border-b-purple-500 border">
      ...
      <div className=" top-0 md:hidden px-8 py-2 flex justify-between w-full items-center">
        ...
        <Link href="/contact">
          <h1 className="text-black border-black font-font font-semibold border px-4 py-2 hover:bg-purple-500 transition transform duration-200 ease-in-out">
            Contact
          </h1>
        </Link>
      </div>
